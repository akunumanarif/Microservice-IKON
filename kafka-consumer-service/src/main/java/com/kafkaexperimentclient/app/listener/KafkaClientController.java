...
public class KafkaClientController {
    ...
    @KafkaListener(topics = {"advice-topic", "product-catalog-topic", "user-data-topic", "order-topic"}, clientIdPrefix = "string",
    ...
    @KafkaListener(topics = {"advice-topic", "product-catalog-topic", "user-data-topic", "order-topic"}, clientIdPrefix = "bytearray",
